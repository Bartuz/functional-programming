...
(define tests
  (test-suite
   ...
   (check-equal? (sequence 5 5 2) (list 5) "Sequence test")
   (check-equal? (sequence 5 1 2) null "Sequence test")
   ...
   (check-exn (regexp "list-nth-mod: empty list") (lambda () (list-nth-mod null 2)) "list-nth-mod empty list test")
   (check-exn (regexp "list-nth-mod: negative number") (lambda () (list-nth-mod (list 1 2 3) -1)) "list-nth-mod empty list test")
   
   ; stream-for-n-steps test
   (check-equal? (stream-for-n-steps (lambda () (cons 1 ones)) 1) (list 1) "stream-for-n-steps test")
  
   (check-equal? (stream-for-n-steps powers-of-two 2) (list 2 4) "stream-for-n-steps test")
   ...
   (check-equal? (vector-assoc 43 (vector (cons 2 1) (cons 3 1) (cons 4 1) (cons 5 1))) #f "vector-assoc test")
